...
function bplike_blog_post_comment_button( $content ) {
    ...
    if ( is_user_logged_in() ) {
        ...
        if ( ! bp_like_is_liked( get_comment_ID(), 'blog_post_comment', get_current_user_id() ) ) { ?>
            <br><a href="#" class="blogpost_comment like <?php if (bp_like_get_settings('bp_like_toggle_button')) echo 'toggle'; ?>" id="like-blogpost-comment-<?php echo get_comment_ID(); ?>" title="<?php echo bp_like_get_text( 'like_this_item' ); ?>"><?php echo bp_like_get_text( 'like' );
        } else { ?>
            <br><a href="#" class="blogpost_comment unlike <?php if (bp_like_get_settings('bp_like_toggle_button')) echo 'toggle'; ?>" id="unlike-blogpost-comment-<?php echo get_comment_ID(); ?>" title="<?php echo bp_like_get_text( 'unlike_this_item' ); ?>"><?php if (bp_like_get_settings('bp_like_toggle_button')) { ?><span class="like-text"><?php echo bp_like_get_text( 'like' ); ?></span><?php } ?><span class="unlike-text"><?php echo bp_like_get_text( 'unlike' ); ?></span><?php } ?><span class="like-count"><?php echo ($liked_count?$liked_count:''); ?></span></a><br><?php
