    ...
    if ( is_user_logged_in() ) {
      if ( bp_get_activity_type() !== 'activity_liked' && bp_get_activity_type() != 'blogpost_liked' ) {
        ...
        if ( ! bp_like_is_liked( bp_get_activity_id(), 'activity_update', get_current_user_id() ) ) { ?>
            <a href="#" class="button bp-primary-action like <?php if (bp_like_get_settings('bp_like_toggle_button')) echo 'toggle'; ?>" id="bp-like-activity-<?php echo bp_get_activity_id(); ?>" title="<?php echo bp_like_get_text( 'like_this_item' ); ?>">
                <?php echo bp_like_get_text( 'like' ); ?>
        <?php } else { ?>
            <a href="#" class="button bp-primary-action unlike <?php if (bp_like_get_settings('bp_like_toggle_button')) echo 'toggle'; ?>" id="bp-like-activity-<?php echo bp_get_activity_id(); ?>" title="<?php echo bp_like_get_text( 'unlike_this_item' ); ?>">
